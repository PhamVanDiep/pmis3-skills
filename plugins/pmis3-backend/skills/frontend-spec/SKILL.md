...
- The frontend repo (`pmis3-nguon-frontend`) is a sibling directory to the backend repo (`pmis3-nguon-backend-quantri`) under `D:\SourceCode\PMIS3\PMIS3-NGUON\`
...
- Base URL: `/pmis3-nguon-quantri/v1`
